...
class TestWriteProtectedProvider(SampleProviderTest):

    def test_write_manifest_enforcement(self, fuzz_connection):
    ...
    def get_enforcement_detector(self) -> EnforcementDetector:
        return WriteEnforcementDetector()

    def expected_output_file_name(self) -> str:
        return 'expected_output_test_write_manifest_enforcement.json'
