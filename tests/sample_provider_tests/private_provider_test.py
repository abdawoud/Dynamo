...
class TestPrivateProvider(SampleProviderTest):

    def test_private_manifest_enforcement(self, fuzz_connection):
    ...
    def get_enforcement_detector(self) -> EnforcementDetector:
        return PrivateEnforcementDetector()

    def expected_output_file_name(self) -> str:
        return 'expected_output_test_private_manifest_enforcement.json'
